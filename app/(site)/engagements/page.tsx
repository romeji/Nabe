...
export default async function PageEngagements() {
  ...
  return (
    <div className="page-marque">
      <section className="page-marque__hero" style={{ backgroundImage: "url('/images/signature-bague.jpg')" }}>
      ...
      <section className="page-marque__bloc conteneur">
        <div className="page-marque__image">
          <Image src="/images/bague-atelier.jpg" alt="Bague en argent travaillée en atelier" width={620} height={520} />
        </div>
      ...
      <section className="page-marque__bloc page-marque__bloc--inverse conteneur">
        ...
        <div className="page-marque__image">
          <Image src="/images/savoirfaire-inspiration.jpg" alt="Inspiration et matière autour d'un bijou" width={620} height={520} />
        </div>
      </section>
