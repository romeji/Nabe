    ...
    <div className="page-info">
      ...
      <section className="page-info__section">
        ...
        <ul>
          ...
          <li>Bijoux en fabrication sur commande : délai indiqué sur la fiche produit, généralement autour de 7 jours ouvrés avant expédition</li>
          <li>Pièces sur-mesure : délai communiqué individuellement après validation du devis</li>
        </ul>
        <h3>Délais de transport indicatifs</h3>
        <ul>
          <li>Livraison suivie : 3 à 7 jours ouvrés après expédition</li>
        </ul>
        <p>
      ...
      <section className="page-info__section">
        ...
        <p>
          ...
          commande pour exercer votre droit de rétractation sur un bijou non personnalisé. Après nous
          avoir informés de votre décision, vous disposez de 14 jours supplémentaires pour nous retourner
          le bijou. Si votre commande n'a pas encore été expédiée, vous pouvez également l'annuler
          vous-même et être intégralement remboursé(e) directement depuis notre page{' '}
          <Link href="/suivi-commande">Suivre ma commande</Link>.
        </p>
        ...
        <p>
          ...
          <strong> ni être retournées, ni échangées, ni remboursées au titre du droit de rétractation</strong>,
          sauf défaut de conformité ou vice caché :
        </p>
        <ul>
          <li>Toute pièce réalisée sur-mesure ou personnalisée (gravure, dimensions spécifiques)</li>
          <li>Toute bague fabriquée ou ajustée spécifiquement à une taille demandée hors stock standard</li>
        </ul>
        <p>
        ...
        <p>
          Pour un retour éligible, un défaut constaté ou toute autre question sur une commande déjà
          passée, contactez-nous via la page <Link href="/contact">Contact</Link> en indiquant votre
          numéro de commande. Vous pouvez retrouver ce numéro depuis la page{' '}
          <Link href="/suivi-commande">Suivre ma commande</Link> ou depuis <Link href="/mon-compte/commandes">Mes commandes</Link>{' '}
          si vous êtes connecté·e.
        </p>

        <h3>Remboursement</h3>
        <p>
          En cas de rétractation valable, nous remboursons les sommes encaissées, y compris les frais
          de livraison standard facturés à la commande le cas échéant, dans un délai maximum de 14 jours
          à compter de la réception de votre demande de rétractation. Nous pouvons différer le
          remboursement jusqu'à réception du bijou retourné ou jusqu'à ce que vous fournissiez une preuve
          d'expédition du retour.
        </p>
      </section>
